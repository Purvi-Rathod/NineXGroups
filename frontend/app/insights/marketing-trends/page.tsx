...
const stats = [
  ["7", "channels benchmarked"],
  ["+34%", "shift toward AI-led creative"],
  ["2026", "budgets & forecasts"],
  ["40+", "campaigns analysed"],
];

const chapters = [
  ["01", "The Channel Shift", "Where attention and budget are moving — and the channels quietly losing both."],
  ["02", "AI in the Creative Stack", "How generative tools are reshaping production, testing, and creative velocity."],
  ["03", "GEO & Discovery", "Generative engine optimisation and the next frontier of organic visibility."],
  ["04", "Performance & Measurement", "Attribution that survives privacy changes, and the metrics that still matter."],
  ["05", "Conversion Psychology", "Why emotion-led funnels outperform feature-led ones, with real examples."],
  ["06", "The 2026 Budget Blueprint", "How to allocate spend across channels for the year ahead."],
];
  ...
  return (
    <main style={FONT} className="w-full overflow-x-hidden bg-[#f3f3f1] text-[#0A1633]">
      <section className="relative overflow-hidden bg-[#0A1633] text-white">
        <div className="absolute -left-40 -top-40 h-[520px] w-[520px] bg-[#2563EB]/30 blur-[160px]" />
        <div className="relative mx-auto grid w-full max-w-[1220px] grid-cols-1 lg:grid-cols-[1fr_0.8fr] gap-12 px-5 sm:px-6 lg:px-8 pt-[80px] sm:pt-[104px] pb-[72px] items-center">
          <div>
            ...
            <motion.h1 {...rise()} className="text-[44px] sm:text-[60px] lg:text-[74px] font-medium leading-[0.92] tracking-[-0.045em]">
              Digital Marketing{" "}
            ...
            <motion.p {...rise(1)} className="mt-7 max-w-[52ch] text-[15px] sm:text-[17px] leading-[1.7] text-white/75">
              The channels, formats, and budgets defining performance marketing
              this year — benchmarked across real campaigns and spend.
            </motion.p>
          ...
          <motion.div {...rise(2)} className="relative mx-auto w-full max-w-[360px]">
            <div className="relative aspect-[3/4] overflow-hidden border border-white/15 shadow-2xl">
              <Image src="https://images.unsplash.com/photo-1611926653458-09294b3142bf?q=80&w=1000&auto=format&fit=crop" alt="Digital Marketing Trends cover" fill className="object-cover opacity-90" />
              ...
              <div className="absolute bottom-0 left-0 p-7">
                ...
                <p className="mt-2 text-[28px] font-medium leading-[1.04] tracking-[-0.03em]">Digital Marketing</p>
                <p className="text-[36px] font-medium leading-[0.9] tracking-[-0.04em] text-[#7db5ff]">Trends</p>
              </div>
            </div>
          </motion.div>
        </div>
