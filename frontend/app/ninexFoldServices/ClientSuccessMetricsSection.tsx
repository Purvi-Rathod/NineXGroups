      ...
      <div className="mx-auto w-full max-w-full px-3 lg:px-0 mt-20 mb-20">
        <div className="w-full grid grid-cols-1 gap-[2px] border border-[#e6e6e3] bg-[#e6e6e3] lg:grid-cols-[250px_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_60px]">
          <div className="relative flex min-h-[500px] flex-col justify-between overflow-hidden bg-[#f8f8f6] px-[22px] py-[22px]">
            ...
            <div className="absolute right-[100px] top-[120px] h-[380px] w-px bg-[#ff6a00]" />
            <div className="absolute right-[100px] top-[240px] h-px w-[90px] bg-[#ff6a00]" />
            <div className="absolute right-[0px] top-[240px] w-[130px] rotate-[-45deg] border-t border-[#ff6a00]" />

            <div className="max-w-[160px] space-y-1 pb-2 text-[12px] font-medium uppercase leading-[1.6] text-black">
              <p>MEASURED OUTCOMES</p>
              <p>ACROSS REVENUE,</p>
              <p>
                OPERATIONS, <span className="text-[#ff6a00]">AND</span>
              </p>
              <p className="text-[#ff6a00]">ADOPTION.</p>
            </div>
          </div>
          ...
          <div className="relative hidden min-h-[500px] overflow-hidden bg-[#f8f8f6] lg:block min-w-0">
            <div className="absolute left-1/2 top-0 h-full w-px -translate-x-1/2 bg-[#ff6a00]" />

            <div className="absolute left-1/2 top-[70px] h-px w-[110px] -translate-x-1/2 bg-[#ff6a00]" />
            <div className="absolute left-1/2 top-[70px] w-[110px] -translate-x-1/2 rotate-[-45deg] border-t border-[#ff6a00]" />

            <div className="absolute bottom-[80px] left-1/2 h-px w-[110px] -translate-x-1/2 bg-[#ff6a00]" />
            <div className="absolute bottom-[80px] left-1/2 w-[110px] -translate-x-1/2 rotate-[45deg] border-t border-[#ff6a00]" />
          </div>
        </div>
        ...
        <div className="mt-[10px] w-full grid grid-cols-1 gap-[2px] border-x border-b border-[#e6e6e3] bg-[#e6e6e3] lg:grid-cols-[1.45fr_0.95fr]">
              ...
              <div className="flex items-end justify-between gap-4">
                <div>
                  <div className="mb-3 flex items-center gap-3">
                    <div className="h-[8px] w-[8px] bg-[#ff6a00]" />
          ...
          <div className="flex min-h-[340px] min-w-0 flex-col justify-between overflow-hidden bg-[#f8f8f6]">
            <div>
              <div className="px-[28px] pb-[18px] pt-[18px]">
                <div className="flex items-start gap-3">
                  <div className="h-[24px] w-[24px] border-[4px] border-r-transparent border-[#ff6a00]" />

                  <div className="space-y-[2px] leading-none">
                    <p className="text-[10px] font-semibold uppercase">SMART</p>
                    <p className="text-[10px] font-semibold uppercase">INVEST*</p>
                    <p className="text-[10px] font-semibold uppercase">GROUP</p>
                  </div>
                </div>
              </div>

              <div className="h-px w-full bg-[#ff6a00]/60" />

              <div className="px-[28px] py-[28px]">
                <p className="mb-5 text-[11px] uppercase tracking-wide text-[#ff6a00]">
                  INSIGHT
                </p>

                <h3 className="max-w-[360px] text-[32px] font-normal leading-[1.15] tracking-[-1.5px] text-black">
            ...
            <div>
              ...
              <div className="px-[28px] py-[20px]">
                <p className="mb-1 text-[11px] uppercase text-black">
                  READ OUR LATEST
                </p>

                <p className="text-[10px] uppercase tracking-wide text-[#ff6a00]">
                  PROPERTY INSIGHTS
                </p>
              </div>
            </div>
...
function MetricCard({
  ...
  return (
    <div className="flex min-h-[500px] min-w-0 flex-col overflow-hidden bg-[#f8f8f6] px-[22px] py-[22px]">
      <div className="mb-[24px] flex items-center gap-3">
        <div className="flex h-[46px] w-[46px] shrink-0 items-center justify-center rounded-full border border-[#ff6a00] text-[#ff6a00]">
          {icon}
        </div>

        <h3 className="text-[15px] font-normal tracking-[-0.3px] text-black">
          {title}
        </h3>
      </div>
      ...
      <div className="flex flex-1 flex-col justify-between">
        <div>
          {items.map((item) => (
            ...
            >
              <div className="whitespace-nowrap text-[22px] font-light leading-none tracking-[0px] text-[#ff6a00]">
                {item[0]}
              </div>

              <p className="max-w-full break-words pt-1 text-[12px] leading-[1.4] text-black">
                {item[1]}
              </p>
            </div>
          ))}
        ...
        {(footerTitle || footerText) && (
          <div className="flex items-end justify-between gap-3 pt-[18px]">
            ...
            {showArrow ? (
              <button className="flex h-[36px] w-[36px] items-center justify-center rounded-full border border-black/30 transition-all duration-300 hover:bg-black hover:text-white">
                <ArrowRight size={16} strokeWidth={1.5} />
              </button>
            ) : null}
          </div>
