...
function CardIcon({ type }: { type: string }) {
    const className = "h-[64px] w-[64px] text-[#8b5cf6] sm:h-[72px] sm:w-[72px]";
            ...
            <div className="w-full max-w-[1220px] mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-5 lg:gap-y-0 gap-0 mb-[42px] lg:mb-[58px]">
                    ...
                    <div className="lg:col-span-3 flex items-start pt-[4px] lg:pt-[10px]">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="w-[8px] h-[8px] bg-[#8b5cf6]" />

                            <p className="text-[13px] tracking-[1.4px] font-semibold text-[#8b5cf6] uppercase">
                                What We Do
                            </p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[10px] sm:gap-[8px] lg:gap-[6px]">
                    ...
                    <div className="min-h-[300px] sm:min-h-[320px] lg:min-h-[336px] px-[18px] sm:px-[22px] lg:px-[24px] pt-[18px] sm:pt-[20px] lg:pt-[22px] pb-[16px] sm:pb-[18px]">
                        ...
                        <p className="text-[13px] sm:text-[14px] leading-[1.9] sm:leading-[2] font-semibold text-[#7c3aed]">
                    ...
                    {cards.map((card, index) => (
                        ...
                        >
                            ...
                            <div className="mb-[18px]">
                                ...
                                <span className="text-[11px] tracking-[2px] uppercase text-[#8b5cf6] font-semibold">
                                    Feature {index + 1}
                                </span>
                            </div>
                            ...
                            {/* HIGHLIGHT */}
                            <p className="text-[15px] sm:text-[16px] leading-[1.7] tracking-[-0.2px] text-[#7c3aed] mb-[22px] max-w-[340px]">
                                {card.highlight}
                            </p>
