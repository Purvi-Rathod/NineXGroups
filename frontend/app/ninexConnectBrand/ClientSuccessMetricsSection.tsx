...
export default function ClientSuccessMetricsSection({
  ...
  return (
    <section className="w-full overflow-x-hidden bg-[#f6f4f8] py-3">
      <div className="mx-auto w-full max-w-[1220px] px-3 lg:px-0 mt-20 mb-20">
        {/* TOP GRID */}
        <div className="grid w-full grid-cols-1 gap-[2px] border border-[#e7e4ec] bg-[#e7e4ec] lg:grid-cols-[250px_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_60px]">
          ...
          <div className="relative flex min-h-[500px] flex-col justify-between overflow-hidden bg-white px-[22px] py-[22px]">
            ...
            {/* Cyan Decorative Lines */}
            <div className="absolute right-[100px] top-[120px] h-[380px] w-px bg-[#22D3EE]" />
            <div className="absolute right-[100px] top-[240px] h-px w-[90px] bg-[#22D3EE]" />
            <div className="absolute right-[0px] top-[240px] w-[130px] rotate-[-45deg] border-t border-[#22D3EE]" />
          ...
          <div className="relative hidden min-h-[500px] overflow-hidden bg-white lg:block min-w-0">
            <div className="absolute left-1/2 top-0 h-full w-px -translate-x-1/2 bg-[#22D3EE]" />

            <div className="absolute left-1/2 top-[70px] h-px w-[110px] -translate-x-1/2 bg-[#22D3EE]" />
            <div className="absolute left-1/2 top-[70px] w-[110px] -translate-x-1/2 rotate-[-45deg] border-t border-[#22D3EE]" />

            <div className="absolute bottom-[80px] left-1/2 h-px w-[110px] -translate-x-1/2 bg-[#22D3EE]" />
            <div className="absolute bottom-[80px] left-1/2 w-[110px] -translate-x-1/2 rotate-[45deg] border-t border-[#22D3EE]" />
          </div>
        </div>
          ...
          <div className="relative min-h-[340px] overflow-hidden bg-black">
            ...
            <div className="relative z-10 flex h-full flex-col justify-between px-[22px] py-[22px]">
              <div className="flex items-start gap-3 text-white">
                <div className="h-[38px] w-[38px] rounded-full border-[5px] border-r-transparent border-[#22D3EE]" />
            ...
            <div>
              <div className="px-[28px] pb-[18px] pt-[18px]">
                <div className="flex items-start gap-3">
                  <div className="h-[24px] w-[24px] rounded-full border-[4px] border-r-transparent border-[#22D3EE]" />
