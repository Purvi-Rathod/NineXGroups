...
export default function QuickLinks() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 bg-[#ECF9FB]">
      <div className="container max-w-[1200px] mx-auto">
        {/* Section Header */}
        <div className="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-16">
          <h2 className="global-heading-style mb-3 sm:mb-4">
            Quick Links
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-[#0A0A0A]/75 max-w-3xl mx-auto leading-[1.6] sm:leading-[1.7] px-2 sm:px-0">
            We build brands, tech, operations, and systems that help companies scale with confidence.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
          {links.map((link, index) => (
            <div
              key={index}
              className="relative rounded-2xl overflow-hidden group cursor-pointer transition-transform duration-300 hover:scale-[1.02] w-full max-w-[391px] mx-auto h-[180px] sm:h-[200px] md:h-[220px] lg:h-[241px]"
            >
              {/* Background Image */}
              <div
              ...
              {/* Dark Overlay - Increased contrast on hover */}
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/50 to-black/30 group-hover:from-black/60 group-hover:via-black/40 group-hover:to-black/20 transition-all duration-300" />
              ...
              <div className="absolute inset-0 flex flex-col p-5 sm:p-6 md:p-7 lg:p-8">
                ...
                <div className="mt-auto">
                  <div className="inline-block">
                    ...
                    { (
                            <div className="h-[2px] mt-[10px] w-full bg-white/30" />
                          )}
                  </div>
                </div>
