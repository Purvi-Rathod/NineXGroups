...
export default function OurVision({
    ...
    return (
        <section className="relative overflow-hidden bg-[#f3f3f1]">
            ...
            {/* BACKGROUND */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,_rgba(255,90,50,0.42),_transparent_42%)]" />
            ...
            {/* LEFT GLOW */}
            <div className="absolute bottom-[-180px] left-[-180px] w-[500px] h-[500px] bg-[#ff6a3d]/45 blur-[150px]" />
            {/* RIGHT GLOW */}
            <div className="absolute top-[-180px] right-[-180px] w-[420px] h-[420px] bg-[#ff6a3d]/45 blur-[160px]" />
